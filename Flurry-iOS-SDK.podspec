...
Pod::Spec.new do |s|
  ...
  s.subspec 'FlurrySDK' do |ss|
    ...
    ss.vendored_libraries = "Flurry/libFlurry_9.3.0.xcode9.a"
  end
  ...
  s.subspec 'FlurryWatchOSSDK' do |ss|
    ...
    ss.vendored_libraries = "Flurry/libFlurryWatch_9.3.0.xcode9.a"
  end
  ...
  s.subspec 'FlurryTVOS' do |ss|
     ...
     ss.frameworks = 'Foundation', 'SystemConfiguration', 'UIKit', 'Security'
     ss.vendored_libraries = "Flurry/libFlurryTVOS_9.3.0.xcode9.a"
   end
  ...
  s.subspec 'FlurryMessaging' do |ss|
    ...
    ss.platform   = :ios, '8.0'
    ss.vendored_libraries = "FlurryMessaging/libFlurryMessaging_9.3.0.xcode9.a"
    ss.dependency 'Flurry-iOS-SDK/FlurrySDK'
  end
  ...
  s.subspec 'FlurryConfig' do |ss|
    ...
    ss.platform   = :ios, '8.0'
    ss.vendored_libraries = "FlurryConfig/libFlurryConfig_9.3.0.xcode9.a"
    ss.dependency 'Flurry-iOS-SDK/FlurrySDK'
  end
end
