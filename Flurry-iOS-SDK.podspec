...
Pod::Spec.new do |s|
  ...
  s.subspec 'FlurrySDK' do |ss|
    ...
    ss.ios.vendored_libraries = 'Flurry/libFlurry_10.3.2.a'
    ...
    ss.tvos.vendored_libraries = 'Flurry/libFlurryTVOS_10.3.2.a'
    ...
    ss.watchos.vendored_libraries = "Flurry/libFlurryWatch_10.3.2.a"
  end
  ...
  s.subspec 'FlurryWatchSDK' do |ss|
    ...
    ss.vendored_libraries = "Flurry/libFlurry_10.3.2.a"
  end
  ...
  s.subspec 'FlurryWatchOSSDK' do |ss|
    ...
    ss.vendored_libraries = "Flurry/libFlurryWatch_10.3.2.a"
  end
  ...
  s.subspec 'FlurryTVOS' do |ss|
    ...
    ss.vendored_libraries = "Flurry/libFlurryTVOS_10.3.2.a"
  end
  ...
  s.subspec 'FlurryConfig' do |ss|
    ...
    ss.platform   = :ios, '8.0'
    ss.vendored_libraries = "FlurryConfig/libFlurryConfig_10.3.2.a"
  ...
  s.subspec 'FlurryMessaging' do |ss|
    ...
    ss.ios.deployment_target = '8.0'
    ss.ios.vendored_libraries = "FlurryMessaging/libFlurryMessaging_10.3.2.a"

    ss.tvos.deployment_target = '9.0'
    ss.tvos.vendored_libraries = "FlurryMessaging/libFlurryMessagingTV_10.3.2.a"
  ...
  s.subspec 'FlurryAds' do |ss|
    ...
    ss.dependency 'Flurry-iOS-SDK/FlurrySDK',  '~> 10.3.2'
  end
